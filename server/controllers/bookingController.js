...
const checkAvailability = async ({ checkInDate, checkOutDate, room }) => {
    try {
        // Ensure dates are Date instances if model fields are Date
        // (if strings from frontend, will work with Mongo but typecasting is safest)
        const bookings = await Booking.find({
            room, // should be ObjectId or string convertible to ObjectId
        ...
        // Optionally throw error to caller
        throw error;
    }
}
